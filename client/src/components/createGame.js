...
const CreateGame = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-full h-full overflow-auto">
      ...
      <div id="createQuestionsDiv" className={ gameId ? "transition-all duration-500 flex flex-col w-4/5 h-screen bg-manatee rounded-lg my-4 overflow-auto items-center" :
        ...
        <form id="questionEntryForm" className="flex flex-col h-full w-full justify-center items-center">
          ...
          {questionType && <h2 className="text-aliceBlue mt-2 text-lg">Answer</h2>}
